...
public class Empresa {
    ...
    public Ruta crearRuta(Municipio[] recorrido, double precio, String tipoVehiculo, String horaSalida, int cantidadAsientos, String fecha) {
        Ruta ruta = new Ruta(siguienteId++, recorrido, precio, tipoVehiculo, horaSalida, cantidadAsientos, fecha);
        rutas.agregar(ruta);
        return ruta;
    }
